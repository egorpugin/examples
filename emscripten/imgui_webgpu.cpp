...
c++: 23
deps:
    - org.sw.demo.ocornut.imgui.backend.emscripten_glfw
    - org.sw.demo.ocornut.imgui.backend.wgpu
*/

// sw build main.cpp -static --settings-file win2emscripten.json -wait-for-cc-checks
